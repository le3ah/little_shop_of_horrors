...
create(:fulfilled_order_item, order: order_1, item: item_1, price: 1, quantity: 1, created_at: 17.days.ago, updated_at: 12.days.ago)
create(:fulfilled_order_item, order: order_1, item: item_2, price: 2, quantity: 1, created_at: 71.days.ago, updated_at: 62.days.ago)
create(:fulfilled_order_item, order: order_1, item: item_3, price: 3, quantity: 1, created_at: 7.days.ago, updated_at: 2.days.ago)
create(:fulfilled_order_item, order: order_1, item: item_4, price: 4, quantity: 1, created_at: 27.days.ago, updated_at: 21.days.ago)
create(:fulfilled_order_item, order: order_1, item: item_5, price: 4, quantity: 9, created_at: 7.days.ago, updated_at: 2.days.ago)
create(:fulfilled_order_item, order: order_1, item: item_6, price: 4, quantity: 1, created_at: 37.days.ago, updated_at: 20.days.ago)
create(:fulfilled_order_item, order: order_1, item: item_7, price: 7, quantity: 1, created_at: 72.days.ago, updated_at: 12.days.ago)
create(:fulfilled_order_item, order: order_1, item: item_8, price: 4, quantity: 1, created_at: 47.days.ago, updated_at: 22.days.ago)
create(:fulfilled_order_item, order: order_1, item: item_9, price: 7, quantity: 2, created_at: 74.days.ago, updated_at: 32.days.ago)

order_2 = create(:completed_order, user: user_3)
create(:fulfilled_order_item, order: order_2, item: item_10, price: 1, quantity: 1, created_at: 3.days.ago, updated_at: 2.days.ago)
create(:fulfilled_order_item, order: order_2, item: item_12, price: 2, quantity: 1, created_at: 2.days.ago, updated_at: 1.days.ago)
create(:fulfilled_order_item, order: order_2, item: item_13, price: 3, quantity: 1, created_at: 7.days.ago, updated_at: 2.days.ago)
create(:fulfilled_order_item, order: order_2, item: item_14, price: 4, quantity: 2, created_at: 17.days.ago, updated_at: 12.days.ago)
create(:fulfilled_order_item, order: order_2, item: item_15, price: 4, quantity: 9, created_at: 20.days.ago, updated_at: 19.days.ago)
create(:fulfilled_order_item, order: order_2, item: item_16, price: 4, quantity: 5, created_at: 15.days.ago, updated_at: 12.days.ago)
create(:fulfilled_order_item, order: order_2, item: item_17, price: 7, quantity: 1, created_at: 75.days.ago, updated_at: 52.days.ago)
create(:fulfilled_order_item, order: order_2, item: item_18, price: 4, quantity: 1, created_at: 7.days.ago, updated_at: 2.days.ago)
create(:fulfilled_order_item, order: order_2, item: item_19, price: 7, quantity: 2, created_at: 7.days.ago, updated_at: 3.days.ago)

order_3 = create(:completed_order, user: user_10)
create(:fulfilled_order_item, order: order_3, item: item_10, price: 1, quantity: 2, created_at: 4.days.ago, updated_at: 2.days.ago)
create(:fulfilled_order_item, order: order_3, item: item_12, price: 2, quantity: 1, created_at: 3.days.ago, updated_at: 2.days.ago)
create(:fulfilled_order_item, order: order_3, item: item_13, price: 3, quantity: 12, created_at: 17.days.ago, updated_at: 12.days.ago)
create(:fulfilled_order_item, order: order_3, item: item_14, price: 4, quantity: 22, created_at: 22.days.ago, updated_at: 21.days.ago)
create(:fulfilled_order_item, order: order_3, item: item_15, price: 4, quantity: 9, created_at: 7.days.ago, updated_at: 2.days.ago)
create(:fulfilled_order_item, order: order_3, item: item_16, price: 4, quantity: 5, created_at: 34.days.ago, updated_at: 24.days.ago)
create(:fulfilled_order_item, order: order_3, item: item_17, price: 7, quantity: 1, created_at: 47.days.ago, updated_at: 32.days.ago)
create(:fulfilled_order_item, order: order_3, item: item_18, price: 4, quantity: 5, created_at: 47.days.ago, updated_at: 42.days.ago)
create(:fulfilled_order_item, order: order_3, item: item_19, price: 7, quantity: 2, created_at: 57.days.ago, updated_at: 52.days.ago)

order_4 = create(:order, user: user_4)
create(:order_item, order: order_4, item: item_1, price: 1, quantity: 1, created_at: 17.days.ago, updated_at: 12.days.ago)
create(:fulfilled_order_item, order: order_4, item: item_2, price: 2, quantity: 1, created_at: 3.days.ago, updated_at: 2.days.ago)

order_5 = create(:order, user: user_8)
create(:order_item, order: order_5, item: item_1, price: 1, quantity: 10, created_at: 6.days.ago, updated_at: 2.days.ago)
create(:fulfilled_order_item, order: order_5, item: item_2, price: 2, quantity: 12, created_at: 10.days.ago, updated_at: 9.days.ago)

order_6 = create(:order, user: user_5)
create(:order_item, order: order_6, item: item_1, price: 1, quantity: 1, created_at: 7.days.ago, updated_at: 2.days.ago)
create(:fulfilled_order_item, order: order_6, item: item_2, price: 2, quantity: 1, created_at: 5.days.ago, updated_at: 3.days.ago)
create(:fulfilled_order_item, order: order_6, item: item_15, price: 4, quantity: 2, created_at: 2.days.ago, updated_at: 1.days.ago)

order_7 = create(:order, user: user_2)
create(:order_item, order: order_7, item: item_20, price: 1, quantity: 1, created_at: 9.days.ago, updated_at: 8.days.ago)
create(:fulfilled_order_item, order: order_7, item: item_21, price: 2, quantity: 1, created_at: 8.days.ago, updated_at: 7.days.ago)

order_8 = create(:order, user: user_9)
create(:order_item, order: order_8, item: item_20, price: 1, quantity: 1, created_at: 16.days.ago, updated_at: 12.days.ago)
create(:fulfilled_order_item, order: order_8, item: item_21, price: 2, quantity: 1, created_at: 17.days.ago, updated_at: 12.days.ago)

order_9 = create(:order, user: user_3)
create(:order_item, order: order_9, item: item_22, price: 1, quantity: 1, created_at: 8.days.ago, updated_at: 4.days.ago)
create(:fulfilled_order_item, order: order_9, item: item_23, price: 2, quantity: 1, created_at: 17.days.ago, updated_at: 12.days.ago)
create(:fulfilled_order_item, order: order_9, item: item_24, price: 2, quantity: 1, created_at: 13.days.ago, updated_at: 12.days.ago)

order_10 = create(:order, user: user_8)
create(:order_item, order: order_10, item: item_22, price: 1, quantity: 1, created_at: 7.days.ago, updated_at: 2.days.ago)
create(:fulfilled_order_item, order: order_10, item: item_23, price: 2, quantity: 1, created_at: 17.days.ago, updated_at: 12.days.ago)
create(:fulfilled_order_item, order: order_10, item: item_24, price: 2, quantity: 1, created_at: 14.days.ago, updated_at: 2.days.ago)

order_11 = create(:cancelled_order, user: user_4)
create(:order_item, order: order_11, item: item_11, price: 2, quantity: 1, created_at: 6.days.ago, updated_at: 5.days.ago)
create(:order_item, order: order_11, item: item_3, price: 3, quantity: 1, created_at: 4.days.ago, updated_at: 2.days.ago)

order_12 = create(:cancelled_order, user: user_2)
create(:order_item, order: order_12, item: item_25, price: 2, quantity: 1, created_at: 3.days.ago, updated_at: 2.days.ago)
create(:order_item, order: order_12, item: item_26, price: 3, quantity: 1, created_at: 3.days.ago, updated_at: 2.days.ago)

order_13 = create(:completed_order, user: user_3)
create(:fulfilled_order_item, order: order_13, item: item_27, price: 1, quantity: 1, created_at: 7.days.ago, updated_at: 2.days.ago)
create(:fulfilled_order_item, order: order_13, item: item_28, price: 2, quantity: 1, created_at: 7.days.ago, updated_at: 2.days.ago)
create(:fulfilled_order_item, order: order_13, item: item_29, price: 2, quantity: 1, created_at: 7.days.ago, updated_at: 2.days.ago)

order_14 = create(:completed_order, user: user_6)
create(:fulfilled_order_item, order: order_14, item: item_27, price: 1, quantity: 10, created_at: 17.days.ago, updated_at: 2.days.ago)
create(:fulfilled_order_item, order: order_14, item: item_28, price: 2, quantity: 1, created_at: 17.days.ago, updated_at: 2.days.ago0)
create(:fulfilled_order_item, order: order_14, item: item_29, price: 2, quantity: 1, created_at: 17.days.ago, updated_at: 2.days.ago)

order_15 = create(:completed_order, user: user_4)
create(:fulfilled_order_item, order: order_15, item: item_1, price: 1, quantity: 1, created_at: 13.days.ago, updated_at: 12.days.ago)
create(:fulfilled_order_item, order: order_15, item: item_30, price: 2, quantity: 1, created_at: 11.days.ago, updated_at: 12.days.ago)
create(:fulfilled_order_item, order: order_15, item: item_15, price: 4, quantity: 10, created_at: 17.days.ago, updated_at: 12.days.ago)

order_16 = create(:completed_order, user: user_1)
create(:fulfilled_order_item, order: order_16, item: item_1, price: 1, quantity: 1, created_at: 4.days.ago, updated_at: 2.days.ago)
create(:fulfilled_order_item, order: order_16, item: item_28, price: 2, quantity: 1, created_at: 17.days.ago, updated_at: 2.days.ago)

order_17 = create(:completed_order, user: user_7)
create(:fulfilled_order_item, order: order_17, item: item_1, price: 1, quantity: 4, created_at: 5.days.ago, updated_at: 2.days.ago)
create(:fulfilled_order_item, order: order_17, item: item_28, price: 2, quantity: 5, created_at: 15.days.ago, updated_at: 12.days.ago)

order_18 = create(:completed_order, user: user_2)
create(:fulfilled_order_item, order: order_18, item: item_11, price: 2, quantity: 4, created_at: 12.days.ago, updated_at: 11.days.ago)
create(:fulfilled_order_item, order: order_18, item: item_30, price: 2, quantity: 5, created_at: 7.days.ago, updated_at: 5.days.ago)

order_19 = create(:completed_order, user: user_3)
create(:fulfilled_order_item, order: order_19, item: item_11, price: 2, quantity: 14, created_at: 4.days.ago, updated_at: 2.days.ago)
create(:fulfilled_order_item, order: order_19, item: item_28, price: 2, quantity: 6, created_at: 3.days.ago, updated_at: 2.days.ago)

order_20 = create(:completed_order, user: user_4)
create(:fulfilled_order_item, order: order_20, item: item_11, price: 1, quantity: 6, created_at: 5.days.ago, updated_at: 2.days.ago)
create(:fulfilled_order_item, order: order_20, item: item_28, price: 2, quantity: 3, created_at: 8.days.ago, updated_at: 2.days.ago)
