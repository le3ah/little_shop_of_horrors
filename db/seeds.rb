...
create(:fulfilled_order_item, order: order_1, item: item_1, price: 1, quantity: 1)
create(:fulfilled_order_item, order: order_1, item: item_2, price: 2, quantity: 1)
create(:fulfilled_order_item, order: order_1, item: item_3, price: 3, quantity: 1)
create(:fulfilled_order_item, order: order_1, item: item_4, price: 4, quantity: 1)
create(:fulfilled_order_item, order: order_1, item: item_5, price: 4, quantity: 9)
create(:fulfilled_order_item, order: order_1, item: item_6, price: 4, quantity: 15)
create(:fulfilled_order_item, order: order_1, item: item_7, price: 7, quantity: 13)
create(:fulfilled_order_item, order: order_1, item: item_8, price: 4, quantity: 1)
create(:fulfilled_order_item, order: order_1, item: item_9, price: 7, quantity: 2)

order_2 = create(:completed_order, user: user_3)
create(:fulfilled_order_item, order: order_2, item: item_10, price: 1, quantity: 11)
create(:fulfilled_order_item, order: order_2, item: item_12, price: 2, quantity: 12)
create(:fulfilled_order_item, order: order_2, item: item_13, price: 3, quantity: 1)
create(:fulfilled_order_item, order: order_2, item: item_14, price: 4, quantity: 2)
create(:fulfilled_order_item, order: order_2, item: item_15, price: 4, quantity: 9)
create(:fulfilled_order_item, order: order_2, item: item_16, price: 4, quantity: 5)
create(:fulfilled_order_item, order: order_2, item: item_17, price: 7, quantity: 13)
create(:fulfilled_order_item, order: order_2, item: item_18, price: 4, quantity: 1)
create(:fulfilled_order_item, order: order_2, item: item_19, price: 7, quantity: 2)

order_3 = create(:completed_order, user: user_10)
create(:fulfilled_order_item, order: order_3, item: item_10, price: 1, quantity: 20)
create(:fulfilled_order_item, order: order_3, item: item_12, price: 2, quantity: 12)
create(:fulfilled_order_item, order: order_3, item: item_13, price: 3, quantity: 12)
create(:fulfilled_order_item, order: order_3, item: item_14, price: 4, quantity: 22)
create(:fulfilled_order_item, order: order_3, item: item_15, price: 4, quantity: 9)
create(:fulfilled_order_item, order: order_3, item: item_16, price: 4, quantity: 5)
create(:fulfilled_order_item, order: order_3, item: item_17, price: 7, quantity: 15)
create(:fulfilled_order_item, order: order_3, item: item_18, price: 4, quantity: 5)
create(:fulfilled_order_item, order: order_3, item: item_19, price: 7, quantity: 23)

order_4 = create(:order, user: user_4)
create(:order_item, order: order_4, item: item_1, price: 1, quantity: 1)
create(:fulfilled_order_item, order: order_4, item: item_2, price: 2, quantity: 1)

order_5 = create(:order, user: user_8)
create(:order_item, order: order_5, item: item_1, price: 1, quantity: 10)
create(:fulfilled_order_item, order: order_5, item: item_2, price: 2, quantity: 12)

order_6 = create(:order, user: user_5)
create(:order_item, order: order_6, item: item_1, price: 1, quantity: 1)
create(:fulfilled_order_item, order: order_6, item: item_2, price: 2, quantity: 1)
create(:fulfilled_order_item, order: order_6, item: item_15, price: 4, quantity: 2)

order_7 = create(:order, user: user_2)
create(:order_item, order: order_7, item: item_20, price: 1, quantity: 1)
create(:fulfilled_order_item, order: order_7, item: item_21, price: 2, quantity: 1)

order_8 = create(:order, user: user_9)
create(:order_item, order: order_8, item: item_20, price: 1, quantity: 1)
create(:fulfilled_order_item, order: order_8, item: item_21, price: 2, quantity: 1)

order_9 = create(:order, user: user_3)
create(:order_item, order: order_9, item: item_22, price: 1, quantity: 1)
create(:fulfilled_order_item, order: order_9, item: item_23, price: 2, quantity: 1)
create(:fulfilled_order_item, order: order_9, item: item_24, price: 2, quantity: 1)

order_10 = create(:order, user: user_8)
create(:order_item, order: order_10, item: item_22, price: 1, quantity: 1)
create(:fulfilled_order_item, order: order_10, item: item_23, price: 2, quantity: 1)
create(:fulfilled_order_item, order: order_10, item: item_24, price: 2, quantity: 1)

order_11 = create(:cancelled_order, user: user_4)
create(:order_item, order: order_11, item: item_11, price: 2, quantity: 1)
create(:order_item, order: order_11, item: item_3, price: 3, quantity: 1)

order_12 = create(:cancelled_order, user: user_2)
create(:order_item, order: order_12, item: item_25, price: 2, quantity: 1)
create(:order_item, order: order_12, item: item_26, price: 3, quantity: 1)

order_13 = create(:completed_order, user: user_3)
create(:fulfilled_order_item, order: order_13, item: item_27, price: 1, quantity: 1)
create(:fulfilled_order_item, order: order_13, item: item_28, price: 2, quantity: 1)
create(:fulfilled_order_item, order: order_13, item: item_29, price: 2, quantity: 1)

order_14 = create(:completed_order, user: user_6)
create(:fulfilled_order_item, order: order_14, item: item_27, price: 1, quantity: 10)
create(:fulfilled_order_item, order: order_14, item: item_28, price: 2, quantity: 10)
create(:fulfilled_order_item, order: order_14, item: item_29, price: 2, quantity: 1)

order_15 = create(:completed_order, user: user_4)
create(:fulfilled_order_item, order: order_15, item: item_1, price: 1, quantity: 1)
create(:fulfilled_order_item, order: order_15, item: item_30, price: 2, quantity: 1)
create(:fulfilled_order_item, order: order_15, item: item_15, price: 4, quantity: 10)

order_16 = create(:completed_order, user: user_1)
create(:fulfilled_order_item, order: order_16, item: item_1, price: 1, quantity: 1)
create(:fulfilled_order_item, order: order_16, item: item_28, price: 2, quantity: 1)

order_17 = create(:completed_order, user: user_7)
create(:fulfilled_order_item, order: order_17, item: item_1, price: 1, quantity: 4)
create(:fulfilled_order_item, order: order_17, item: item_28, price: 2, quantity: 5)

order_18 = create(:completed_order, user: user_2)
create(:fulfilled_order_item, order: order_18, item: item_11, price: 2, quantity: 4)
create(:fulfilled_order_item, order: order_18, item: item_30, price: 2, quantity: 5)

order_19 = create(:completed_order, user: user_3)
create(:fulfilled_order_item, order: order_19, item: item_11, price: 2, quantity: 14)
create(:fulfilled_order_item, order: order_19, item: item_28, price: 2, quantity: 6)

order_20 = create(:completed_order, user: user_4)
create(:fulfilled_order_item, order: order_20, item: item_11, price: 1, quantity: 6)
create(:fulfilled_order_item, order: order_20, item: item_28, price: 2, quantity: 3)
