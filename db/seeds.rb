...
create(:fulfilled_order_item, order: order_1, item: item_1, price: item_1.price, quantity: 1)
create(:fulfilled_order_item, order: order_1, item: item_2, price: item_2.price, quantity: 1)
create(:fulfilled_order_item, order: order_1, item: item_3, price: item_3.price, quantity: 1)
create(:fulfilled_order_item, order: order_1, item: item_4, price: item_4.price, quantity: 1)
create(:fulfilled_order_item, order: order_1, item: item_5, price: item_5.price, quantity: 9)
create(:fulfilled_order_item, order: order_1, item: item_6, price: item_6.price, quantity: 15)
create(:fulfilled_order_item, order: order_1, item: item_7, price: item_7.price, quantity: 13)
create(:fulfilled_order_item, order: order_1, item: item_8, price: item_8.price, quantity: 1)
create(:fulfilled_order_item, order: order_1, item: item_9, price: item_9.price, quantity: 2)

order_2 = create(:completed_order, user: user_3)
create(:fulfilled_order_item, order: order_2, item: item_10, price: item_10.price, quantity: 11)
create(:fulfilled_order_item, order: order_2, item: item_12, price: item_12.price, quantity: 12)
create(:fulfilled_order_item, order: order_2, item: item_13, price: item_13.price, quantity: 1)
create(:fulfilled_order_item, order: order_2, item: item_14, price: item_14.price, quantity: 2)
create(:fulfilled_order_item, order: order_2, item: item_15, price: item_15.price, quantity: 9)
create(:fulfilled_order_item, order: order_2, item: item_16, price: item_16.price, quantity: 5)
create(:fulfilled_order_item, order: order_2, item: item_17, price: item_17.price, quantity: 13)
create(:fulfilled_order_item, order: order_2, item: item_18, price: item_18.price, quantity: 1)
create(:fulfilled_order_item, order: order_2, item: item_19, price: item_19.price, quantity: 2)

order_3 = create(:completed_order, user: user_10)
create(:fulfilled_order_item, order: order_3, item: item_10, price: item_10.price, quantity: 20)
create(:fulfilled_order_item, order: order_3, item: item_12, price: item_12.price, quantity: 12)
create(:fulfilled_order_item, order: order_3, item: item_13, price: item_13.price, quantity: 12)
create(:fulfilled_order_item, order: order_3, item: item_14, price: item_14.price, quantity: 22)
create(:fulfilled_order_item, order: order_3, item: item_15, price: item_15.price, quantity: 9)
create(:fulfilled_order_item, order: order_3, item: item_16, price: item_16.price, quantity: 5)
create(:fulfilled_order_item, order: order_3, item: item_17, price: item_17.price, quantity: 15)
create(:fulfilled_order_item, order: order_3, item: item_18, price: item_18.price, quantity: 5)
create(:fulfilled_order_item, order: order_3, item: item_19, price: item_19.price, quantity: 23)

order_4 = create(:order, user: user_4)
create(:order_item, order: order_4, item: item_1, price: item_1.price, quantity: 1)
create(:fulfilled_order_item, order: order_4, item: item_2, price: item_2.price, quantity: 1)

order_5 = create(:order, user: user_8)
create(:order_item, order: order_5, item: item_1, price: item_1.price, quantity: 10)
create(:fulfilled_order_item, order: order_5, item: item_2, price: item_2.price, quantity: 12)

order_6 = create(:order, user: user_5)
create(:order_item, order: order_6, item: item_1, price: item_1.price, quantity: 1)
create(:fulfilled_order_item, order: order_6, item: item_2, price: item_2.price, quantity: 1)
create(:fulfilled_order_item, order: order_6, item: item_15, price: item_15.price, quantity: 2)

order_7 = create(:order, user: user_2)
create(:order_item, order: order_7, item: item_20, price: item_20.price, quantity: 1)
create(:fulfilled_order_item, order: order_7, item: item_21, price: item_21.price, quantity: 1)

order_8 = create(:order, user: user_9)
create(:order_item, order: order_8, item: item_20, price: item_20.price, quantity: 1)
create(:fulfilled_order_item, order: order_8, item: item_21, price: item_21.price, quantity: 1)

order_9 = create(:order, user: user_3)
create(:order_item, order: order_9, item: item_22, price: item_22.price, quantity: 1)
create(:fulfilled_order_item, order: order_9, item: item_23, price: item_23.price, quantity: 1)
create(:fulfilled_order_item, order: order_9, item: item_24, price: item_24.price, quantity: 1)

order_10 = create(:order, user: user_8)
create(:order_item, order: order_10, item: item_22, price: item_22.price, quantity: 1)
create(:fulfilled_order_item, order: order_10, item: item_19, price: item_19.price, quantity: 1)
create(:fulfilled_order_item, order: order_10, item: item_24, price: item_24.price, quantity: 1)

order_11 = create(:cancelled_order, user: user_4)
create(:order_item, order: order_11, item: item_11, price: item_11.price, quantity: 1)
create(:order_item, order: order_11, item: item_3, price: item_3.price, quantity: 1)

order_12 = create(:cancelled_order, user: user_2)
create(:order_item, order: order_12, item: item_25, price: item_25.price, quantity: 1)
create(:order_item, order: order_12, item: item_26, price: item_26.price, quantity: 1)

order_13 = create(:completed_order, user: user_3)
create(:fulfilled_order_item, order: order_13, item: item_27, price: item_27.price, quantity: 1)
create(:fulfilled_order_item, order: order_13, item: item_28, price: item_28.price, quantity: 1)
create(:fulfilled_order_item, order: order_13, item: item_29, price: item_29.price, quantity: 1)

order_14 = create(:completed_order, user: user_6)
create(:fulfilled_order_item, order: order_14, item: item_6, price: item_6.price, quantity: 10)
create(:fulfilled_order_item, order: order_14, item: item_28, price: item_28.price, quantity: 10)
create(:fulfilled_order_item, order: order_14, item: item_29, price: item_29.price, quantity: 1)

order_15 = create(:completed_order, user: user_4)
create(:fulfilled_order_item, order: order_15, item: item_7, price: item_7.price, quantity: 1)
create(:fulfilled_order_item, order: order_15, item: item_30, price: item_30.price, quantity: 1)
create(:fulfilled_order_item, order: order_15, item: item_15, price: item_15.price, quantity: 10)

order_16 = create(:completed_order, user: user_5)
create(:fulfilled_order_item, order: order_16, item: item_14, price: item_14.price, quantity: 1)
create(:fulfilled_order_item, order: order_16, item: item_28, price: item_28.price, quantity: 1)

order_17 = create(:completed_order, user: user_7)
create(:fulfilled_order_item, order: order_17, item: item_1, price: item_1.price, quantity: 4)
create(:fulfilled_order_item, order: order_17, item: item_23, price: item_23.price, quantity: 5)

order_18 = create(:completed_order, user: user_2)
create(:fulfilled_order_item, order: order_18, item: item_11, price: item_11.price, quantity: 40)
create(:fulfilled_order_item, order: order_18, item: item_30, price: item_30.price, quantity: 5)

order_19 = create(:completed_order, user: user_3)
create(:fulfilled_order_item, order: order_19, item: item_10, price: item_10.price, quantity: 14)
create(:fulfilled_order_item, order: order_19, item: item_20, price: item_20.price, quantity: 6)

order_20 = create(:completed_order, user: user_3)
create(:fulfilled_order_item, order: order_20, item: item_11, price: item_11.price, quantity: 14)

order_21 = create(:completed_order, user: user_1)
create(:fulfilled_order_item, order: order_21, item: item_17, price: item_17.price, quantity: 15)
create(:fulfilled_order_item, order: order_21, item: item_28, price: item_28.price, quantity: 12)

order_22 = create(:completed_order, user: user_7)
create(:fulfilled_order_item, order: order_22, item: item_19, price: item_19.price, quantity: 14)
create(:fulfilled_order_item, order: order_22, item: item_21, price: item_21.price, quantity: 5)

order_23 = create(:completed_order, user: user_2)
create(:fulfilled_order_item, order: order_23, item: item_14, price: item_14.price, quantity: 4)
create(:fulfilled_order_item, order: order_23, item: item_30, price: item_30.price, quantity: 5)

order_24 = create(:completed_order, user: user_3)
create(:fulfilled_order_item, order: order_24, item: item_26, price: item_26.price, quantity: 14)
create(:fulfilled_order_item, order: order_24, item: item_22, price: item_22.price, quantity: 6)

order_25 = create(:completed_order, user: user_9)
create(:fulfilled_order_item, order: order_25, item: item_12, price: item_12.price, quantity: 32)

order_26 = create(:completed_order, user: user_8)
create(:fulfilled_order_item, order: order_26, item: item_17, price: item_17.price, quantity: 6)
create(:fulfilled_order_item, order: order_26, item: item_8, price: item_8.price, quantity: 13)

order_27 = create(:completed_order, user: user_2)
create(:fulfilled_order_item, order: order_27, item: item_9, price: item_9.price, quantity: 3)

order_28 = create(:completed_order, user: user_10)
create(:fulfilled_order_item, order: order_28, item: item_18, price: item_18.price, quantity: 1)

order_29 = create(:completed_order, user: user_6)
create(:fulfilled_order_item, order: order_29, item: item_5, price: item_5.price, quantity: 6)

order_30 = create(:completed_order, user: user_7)
create(:fulfilled_order_item, order: order_30, item: item_2, price: item_2.price, quantity: 25)
