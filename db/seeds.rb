...
item_11 = create(:item, user: merchant_1, name: "Sunnyflowers", description: "Sunnyflowers appear to be happy, but upon closer inspection, they’re actually quite angry, often screaming in rage for no apparent reason.  A delight for all who come to see!", enabled: true)
...
item_23 = create(:item, user: merchant_3, name: "Fluke", description: "Fluke is our most beautiful, yet boring, creature.  It lazily lounges in the sun and occasionally swats at passersby with its limbs.", enabled: true)
